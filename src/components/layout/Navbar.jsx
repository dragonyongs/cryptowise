                            ...
                            >
                                ...
                                >
                                    <div className="flex items-center">
                                        <item.icon className={`mr-3 h-5 w-5 transition-colors ${isActive ? 'text-white' : 'text-crypto-neutral-500 group-hover:text-crypto-primary-500'
                                            }`} />
                                        <span>{item.name}</span>
                                    </div>
                                    ...
                                    {item.badge && (
                                        <motion.span
                                            initial={{ scale: 0 }}
                                            animate={{ scale: 1 }}
                                            className={`px-2 py-1 text-xs font-semibold rounded-full ${item.badge === 'NEW'
                ...
                <div className="p-4 border-t border-crypto-neutral-200">
                    <div className="relative">
                        ...
                        >
                            ...
                            <ChevronDownIcon className={`h-4 w-4 text-crypto-neutral-400 transition-transform duration-200 ${showUserMenu ? 'rotate-180' : ''
                                }`} />
                        </button>
